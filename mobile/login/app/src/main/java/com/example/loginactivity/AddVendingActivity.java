    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_add_vending.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                ...
                AddVendingRequest addvendingrequest = new AddVendingRequest(vendingName,vendingComment,vendingSize,vendingSN, responseListener);
                RequestQueue queue = Volley.newRequestQueue(AddVendingActivity.this);
                queue.add(addvendingrequest);
